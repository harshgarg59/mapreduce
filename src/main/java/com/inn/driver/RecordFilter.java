...
import com.inn.mpr.RecordFilterMapper;
import com.inn.rdcr.AvgReducer;

public class RecordFilter extends Configured implements Tool {
	private static final Logger log = Logger.getLogger(RecordFilter.class);
	...
	public static void main(String[] args) throws Exception {
		RecordFilter driver = new RecordFilter();
